...
impl<'str> Element<'str> {
    fn new_for_tag(raw: &'str str, tag: &'str str, arg: Option<&'str str>) -> Self {
        ...
        el.display = match Tag::get_by_name(tag) {
            ...
            Tag::Quote => ElementDisplay::Block,
            Tag::Spoiler => ElementDisplay::Block,
            Tag::Center => ElementDisplay::Block,
            Tag::Left => ElementDisplay::Block,
            Tag::Right => ElementDisplay::Block,
            Tag::List => ElementDisplay::Block,
            Tag::ListItem => ElementDisplay::Block,
            Tag::Table => ElementDisplay::Block,
            Tag::TableRow => ElementDisplay::Block,
